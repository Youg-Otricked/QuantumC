...
## Namespaces
Namespaces are another important feature in QuarticC. Namespaces are a collection of **_Variables_ and _Functions_** **ONLY**. Computation outside functions in a namespace is strictly _prohibited_.
