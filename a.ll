...
@.str.18 = private constant [25 x i8] c"Inside function, length:\00"
@.str.19 = private constant [17 x i8] c"Calling function\00"
@.str.20 = private constant [5 x i8] c"Done\00"
...
entry:
  ...
  call void @qc_list_push(ptr %list_ptr, ptr %temp_elem)
  store i32 2, ptr %temp_elem1, align 4
  call void @qc_list_push(ptr %list_ptr, ptr %temp_elem1)
  store i32 3, ptr %temp_elem2, align 4
  call void @qc_list_push(ptr %list_ptr, ptr %temp_elem2)
  store ptr %list_ptr, ptr %nums, align 8
  call void @qc_println(ptr @.str.18)
...
define i32 @main() {
entry:
  call void @qc_println(ptr @.str.19)
  %calltmp = call ptr @make_list()
  call void @qc_println(ptr @.str.20)
  ret i32 0
}
