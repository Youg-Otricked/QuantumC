; ModuleID = '/home/luca/C^4/runtime.cpp'
source_filename = "/home/luca/C^4/runtime.cpp"
...
define dso_local signext i8 @qc_to_char_from_string(ptr noundef readonly captures(address_is_null) %0) local_unnamed_addr #25 {
  %2 = icmp eq ptr %0, null
  br i1 %2, label %5, label %3
...
40:                                               ; preds = %7, %37, %34, %22, %18, %15, %11, %8
...
116:                                              ; preds = %29, %31, %33, %35, %7, %10, %14, %17, %21, %38, %6, %97
  ret void
}
...
define dso_local void @qc_set_jagged_element(ptr noundef readonly captures(none) %0, i32 noundef %1, ptr noundef %2, i32 noundef %3) local_unnamed_addr #26 {
...
83:                                               ; preds = %46, %80, %77, %65, %61, %58, %54, %51
...
define dso_local ptr @qc_jagged_array_get(ptr noundef readonly captures(address_is_null) %0, ptr noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #27 {
  %4 = icmp ne i32 %2, 0
...
95:                                               ; preds = %85, %7, %13, %3, %22, %27, %31, %50, %80, %65, %61, %55
...
define dso_local void @qc_set_leaf_element(ptr noundef writeonly captures(none) %0, i32 noundef %1, ptr noundef readonly captures(none) %2, i32 noundef %3) local_unnamed_addr #28 {
  %5 = add i32 %3, -2
  %6 = icmp ult i32 %5, 5
  br i1 %6, label %7, label %11
...
100:                                              ; preds = %63, %97, %94, %82, %78, %75, %71, %68
...
define dso_local void @qc_list_push(ptr noundef captures(none) %0, ptr noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #29 {
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @qc_list_set(ptr noundef readonly captures(none) %0, i32 noundef %1, ptr noundef readonly captures(none) %2) local_unnamed_addr #29 {
  %4 = icmp slt i32 %1, 0
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local ptr @qc_list_get(ptr noundef readonly captures(none) %0, i32 noundef %1) local_unnamed_addr #27 {
  %3 = icmp slt i32 %1, 0
...
define dso_local ptr @qc_list_pop(ptr noundef captures(none) %0) local_unnamed_addr #30 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local i32 @qc_list_length(ptr noundef readonly captures(none) %0) local_unnamed_addr #25 {
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %3 = load i32, ptr %2, align 8, !tbaa !64
  ret i32 %3
}
...
35:                                               ; preds = %7, %3, %32, %28, %24, %20, %16, %12, %8
...
219:                                              ; preds = %141, %151, %147, %212
  ret void
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local ptr @qc_map_get(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(address_is_null) %1) local_unnamed_addr #31 {
...
51:                                               ; preds = %17, %12, %39, %35, %31, %27, %23, %19, %43
...
; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local noundef zeroext i1 @qc_map_has(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(address_is_null) %1) local_unnamed_addr #31 {
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 16
  %4 = load i32, ptr %3, align 8, !tbaa !69
  %5 = icmp sgt i32 %4, 0
...
46:                                               ; preds = %17, %12, %39, %35, %31, %27, %23, %19, %43
  %47 = add nuw nsw i64 %13, 1
  %48 = icmp eq i64 %47, %11
  br i1 %48, label %49, label %12, !llvm.loop !76

49:                                               ; preds = %46, %43, %19, %23, %27, %31, %35, %39, %6, %2
  %50 = phi i1 [ false, %2 ], [ false, %6 ], [ true, %39 ], [ true, %35 ], [ true, %31 ], [ true, %27 ], [ true, %23 ], [ true, %19 ], [ true, %43 ], [ false, %46 ]
  ret i1 %50
}

; Function Attrs: mustprogress nofree norecurse nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @qc_map_remove(ptr noundef captures(none) %0, ptr noundef readonly captures(address_is_null) %1) local_unnamed_addr #32 {
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 16
  %4 = load i32, ptr %3, align 8, !tbaa !69
  %5 = icmp sgt i32 %4, 0
...
92:                                               ; preds = %17, %12, %39, %35, %31, %27, %23, %19, %43
...
69:                                               ; preds = %14, %64, %61, %43, %36, %30, %23, %17
...
124:                                              ; preds = %69, %119, %116, %98, %91, %85, %78, %72
...
75:                                               ; preds = %16, %70, %67, %49, %42, %36, %29, %23
...
158:                                              ; preds = %92, %153, %150, %132, %125, %119, %112, %106
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local i32 @qc_map_size(ptr noundef readonly captures(none) %0) local_unnamed_addr #25 {
...
108:                                              ; preds = %96, %109, %100, %41, %32, %50, %81, %16
...
73:                                               ; preds = %14, %68, %65, %47, %40, %34, %27, %21
...
declare i32 @llvm.vector.reduce.mul.v4i32(<4 x i32>) #35
...
attributes #31 = { mustprogress nofree norecurse nounwind willreturn memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #32 = { mustprogress nofree norecurse nounwind memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!4 = !{!"Debian clang version 21.1.8 (7+b1)"}
!5 = distinct !{!5, !6}
